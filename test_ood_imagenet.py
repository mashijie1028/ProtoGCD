...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str, default='imagenet_100', help='options: cifar10, cifar100, imagenet_100, cub, scars, fgvc_aricraft, herbarium_19')
    ...
    # iNaturalist
    ood_data = datasets.ImageFolder(root="/data4/sjma/dataset/OOD/iNaturalist/", transform=test_transform)
    ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
    ...
    get_and_print_results(ood_loader, model, in_score, args)
     ...
     # ImageNet-O
    ood_data = datasets.ImageFolder(root="/data4/sjma/dataset/OOD/ImageNet-O/", transform=test_transform)
    ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
    ...
    # OpenImage-O
    ood_data = datasets.ImageFolder(root="/data4/sjma/dataset/OOD/OpenImage-O/", transform=test_transform)
    ood_loader = torch.utils.data.DataLoader(ood_data, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
