...
def old_cluster_acc(y_true, y_pred, return_ind=False):
    """
    https://github.com/sgvaze/generalized-category-discovery/blob/main/project_utils/cluster_utils.py#L39
    used ONLY for estimating # of novel categories in `estimate_k.py`
